...
class Expediente(Base):
    ...
    # Foreign Key a tribunal
    id_tribunal = Column(
        Integer,
        ForeignKey('tribunal.tribunal_id', ondelete='SET NULL'),
        nullable=True
    )
    
    # Relación con Tribunal (opcional, si el modelo existe)
    # tribunal_rel = relationship("Tribunal", back_populates="expedientes")
